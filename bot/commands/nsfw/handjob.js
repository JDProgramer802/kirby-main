...
const PHRASES = [
  '*{a}* envuelve a *{b}* con la mano hasta el climax.',
  '*{b}* aprieta los dientes mientras *{a}* acelera.',
  '*{a}* domina el ritmo de *{b}* sin soltar.',
  '*{b}* se retuerce con cada caricia de *{a}*.',
];

export default {
  name: 'handjob',
  aliases: [],
  description: 'Hacer una paja con la mano',
  category: 'NSFW',
  usage: '/handjob @usuario',
  cooldown: 5,
  adminOnly: false,
  ownerOnly: false,
  groupOnly: true,
