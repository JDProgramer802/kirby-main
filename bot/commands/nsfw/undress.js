...
const PHRASES = [
  '*{a}* le quita la ropa a *{b}* capa por capa.',
  '*{b}* queda expuesto ante *{a}* sin defensas.',
  '*{a}* rompe el último botón de *{b}*.',
  '*{b}* no puede escapar de las manos de *{a}*.',
];

export default {
  name: 'undress',
  aliases: ['encuerar'],
  description: 'Desnudar a alguien',
  category: 'NSFW',
  usage: '/undress @usuario',
  cooldown: 5,
  adminOnly: false,
  ownerOnly: false,
  groupOnly: true,
