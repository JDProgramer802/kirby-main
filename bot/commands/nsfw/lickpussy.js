...
const PHRASES = [
  '*{a}* se pierde entre las piernas de *{b}*.',
  '*{b}* aprieta los muslos alrededor de *{a}*.',
  '*{a}* lame sin piedad hasta mojar el suelo.',
  '*{b}* grita bajito el nombre de *{a}*.',
];

export default {
  name: 'lickpussy',
  aliases: [],
  description: 'Lamer un coño',
  category: 'NSFW',
  usage: '/lickpussy @usuario',
  cooldown: 5,
  adminOnly: false,
  ownerOnly: false,
  groupOnly: true,
